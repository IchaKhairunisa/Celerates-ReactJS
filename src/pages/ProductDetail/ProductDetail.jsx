      ...
      <div className='flex flex-col gap-[20px]'>
        ...
        {product.stock > 0 ? (
          <div>
            <Button
              type="button"
              className="inline-flex items-center justify-center gap-2 p-4 bg-[#f1f1f1] text-center hover:bg-[#1d1d1d] hover:text-[#f1f1f1] text-[#141414] active:bg-[#161616] rounded-full"
            >
              <FontAwesomeIcon icon={faCartShopping} className="mb-0 text-[#141414] hover:text-[#f1f1f1]" />
              <span className="text-[#141414] hover:text-[#f1f1f1]">Add to cart</span>
            </Button>
          </div>
          ) : (
            <div>
              <Button
                type="button"
                className="inline-flex items-center justify-center gap-2 p-4 bg-[#f1f1f1] text-center rounded-full"
              >
                <FontAwesomeIcon icon={faCartShopping} className="mb-0 text-[#141414]" />
                <span className="text-[#141414]">Add to cart</span>
              </Button>
            </div>
          )}
